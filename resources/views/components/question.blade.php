...
<div class="rounded bg-gray-800/50 shadow shadow-blue-500/50 p-3 text-gray-200 flex justify-between items-center">
    <span>{{ $question->question }}</span>
    <div>
        <x-form :action="route('question.like', $question)">
            <button href="{{ route('question.like', $question) }}" class="flex items-start space-x-1 text-green-500" type="submit">
